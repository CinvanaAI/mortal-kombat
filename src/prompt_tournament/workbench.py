...
class Workbench:
    ...
    def __init__(self, root: tk.Tk, task: dict | None = None, *, discovery=None, transport=None, research=None):
        ...
        self.output_parent = tk.StringVar(value=str(Path.cwd() / 'mortal-kombat-results'))
        ...
        self.root.title('Mortal Kombat · Model Workbench')
    ...
    def _build(self):
        ...
        top = ttk.Frame(outer)
        top.pack(fill='x')
        ttk.Label(top, text='Mortal Kombat', style='Title.TLabel').pack(side='left')
